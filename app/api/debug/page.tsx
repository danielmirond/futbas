  ...
  return (
    <div style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif", background: MD.white, color: MD.black, minHeight: '100vh', maxWidth: 860, margin: '0 auto' }}>
      ...
      <div style={{ borderBottom: `3px solid ${MD.red}`, paddingBottom: 0 }}>
        ...
        <div style={{ background: MD.black, padding: '6px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            {/* Logo MD simplificado */}
            <span style={{ fontWeight: 900, fontSize: 17, color: MD.white, letterSpacing: -0.5, fontStyle: 'italic' }}>
              MUNDO<span style={{ color: MD.yellow }}>DEPORTIVO</span>
            </span>
          </div>
